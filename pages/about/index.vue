        ...
        <div class="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            <div class="flex flex-col lg:flex-row justify-between gap-8">
                ...
                <div class="w-full lg:w-8/12">
                    <img class="w-full h-full" src="@/assets/images/bg_login.png" alt="A group of People" />
                </div>
            </div>
                ...
                <div class="w-full lg:w-8/12 lg:pt-8">
                    <div class="grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 lg:gap-4 shadow-lg rounded-md">
                        <div class="p-4 pb-6 flex justify-center flex-col items-center">
                            <img class="md:block hidden" src="@/assets/images/user1.png"
                                alt="Alexa featured Image" />
                            <img class="md:hidden block" src="@/assets/images/user1.png"
                                alt="Alexa featured Image" />
                            <p class="font-medium text-xl leading-5 text-gray-800 dark:text-white mt-4">Alexa</p>
                        </div>
                        <div class="p-4 pb-6 flex justify-center flex-col items-center">
                            <img class="md:block hidden" src="@/assets/images/user2.png"
                                alt="Olivia featured Image" />
                            <img class="md:hidden block" src="@/assets/images/user2.png"
                                alt="Olivia featured Image" />
                            <p class="font-medium text-xl leading-5 text-gray-800 dark:text-white mt-4">Olivia</p>
                        </div>
                        <div class="p-4 pb-6 flex justify-center flex-col items-center">
                            <img class="md:block hidden" src="@/assets/images/user3.png"
                                alt="Liam featued Image" />
                            <img class="md:hidden block" src="@/assets/images/user3.png"
                                alt="Liam featued Image" />
                            <p class="font-medium text-xl leading-5 text-gray-800 dark:text-white mt-4">Liam</p>
                        </div>
                        <div class="p-4 pb-6 flex justify-center flex-col items-center">
                            <img class="md:block hidden" src="@/assets/images/user4.png"
                                alt="Elijah featured image" />
                            <img class="md:hidden block" src="@/assets/images/user4.png"
                                alt="Elijah featured image" />
