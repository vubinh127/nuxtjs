<template>
    <nav class="bg-[url('@/assets/images/header.png')]">
        <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            <div class="relative flex items-center justify-between h-16">
                ...
                <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                    <div class="flex-shrink-0">
                        <NuxtLink to="/">
                            <img class="block lg:hidden h-8 w-auto" src="@/assets/images/logo.png" alt="Workflow logo">
                        </NuxtLink>
                        <NuxtLink to="/">
                            <img class="hidden lg:block h-8 w-auto" src="@/assets/images/logo.png" alt="Workflow logo">
                        </NuxtLink>
                    </div>
                ...
                <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    ...
                    <div class="ml-3 relative">
                        <div>
                            <NuxtLink v-if="!isLoginned" @click="logout"
                                class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-white transition duration-150 ease-in-out"
                                id="user-menu" aria-label="User menu" aria-haspopup="true">
                                <img class="h-8 w-8 rounded-full animate-spin" src="@/assets/images/logo.png" alt="">
                            </NuxtLink>
                            <NuxtLink v-if="isLoginned"  to="/login"
                                class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-white transition duration-150 ease-in-out"
                                id="user-menu" aria-label="User menu" aria-haspopup="true">
                                <img class="h-8 w-8 rounded-full animate-ping" src="@/assets/images/default_avatar.png" alt="">
                            </NuxtLink>
                        </div>
                        <!--
          ...
          -->
                        <div
                            class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg hidden group-focus:block">
